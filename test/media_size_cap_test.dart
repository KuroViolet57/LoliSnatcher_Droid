...
/// r57: media_kit sizes the Android video surface to the video's native
/// resolution, so an 8K post (4320x7680) froze Skia's drawing for ~7 s and the
/// warm players held ~2.1 GB of graphics memory. Videos are now capped to what
/// the screen can show (in its best orientation, so fullscreen landscape is not
/// softened) and pictures to 4K on their long edge.
void main() {
